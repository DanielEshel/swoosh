...
class Comms:
    ...
    def __init__(self, name: str, interface_name: str):
        ...
        self.recv_info_q = asyncio.Queue()
        self._send_info_q = asyncio.Queue()

        self.recv_server_q = asyncio.Queue()
        self._send_server_q = asyncio.Queue()
